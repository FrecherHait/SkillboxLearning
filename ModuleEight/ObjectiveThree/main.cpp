...
int main() {
	...
	std::cout << "---------------------Задание 3 \"Игрушечная фабрика\"---------------------" << "\n";
  ...
  std::cout << "Из этого можно изготовить " << totalImpossibleCube << " кубиков" << "\n";
  ...
  if (totalImpossibleCube >= 8) {
    ...
    std::cout << "Из этого количества кубиков можно создать набор из " << packOfCube << " кубиков" << "\n";
  }
  else {
